...
namespace VinamiToolUser.Models.Interface
{
    public interface IGetToolRepository
    {
        ...
        Task<bool> UpdateGetToolTransaction(string companyCode, string machineCode,  string userLogin, string workCode, string workMachineCode, string toolCode, string trayIndex, int qtyExchange, string typeTransaction, string transactionStatus);
    }
}
