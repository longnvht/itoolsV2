...
{
    public class OpRepository : IOpRepository
    {
        public async Task<IEnumerable<OPModel>> GetAll(JobModel job)
        {
        ...
        public async Task<IEnumerable<OPModel>> GetByValue(JobModel job, string value)
        {
            var opList = new List<OPModel>();
